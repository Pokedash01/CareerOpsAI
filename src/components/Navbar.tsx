            ...
            <div className="flex items-center gap-2 sm:gap-2.5">
              {onOpenSyncModal && (
                <motion.button
                  ...
                  title="Cross-Device Synchronization Hub"
                  className="flex items-center gap-1.5 text-xs font-medium text-zinc-300 bg-white/[0.04] hover:bg-white/[0.08] px-2.5 sm:px-3 py-2 min-h-[38px] rounded-xl border border-white/[0.08] transition-colors cursor-pointer"
                >
                  <Cloud className="w-3.5 h-3.5 text-emerald-400" />
                  <span className="hidden sm:inline">Sync</span>
                  <span className="text-[10px] text-emerald-400 bg-emerald-500/10 px-1.5 py-0.5 rounded-md font-mono">
                    {jobCount}
                  </span>
                </motion.button>
              )}
