            ...
            <div className="space-y-3 pt-1 text-xs">
              ...
              <div className="p-4 sm:p-5 bg-white/[0.02] rounded-xl border border-white/[0.08] space-y-4 mt-3">
                ...
                <div className="space-y-3 pt-3 border-t border-white/[0.07]">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 bg-[#080A0F]/60 p-2 sm:p-1.5 px-2.5 rounded-xl border border-white/[0.07]">
                    <div className="flex items-center gap-2 min-w-0 flex-1">
                      <span className="text-[10px] text-zinc-400 font-mono shrink-0">Current Origin:</span>
                      <code className="text-[10px] text-blue-300 font-mono truncate">{cronUrl}</code>
                    </div>
                    <button
                      type="button"
                      onClick={handleTestWebhook}
                      disabled={testingWebhook}
                      className="flex items-center justify-center gap-1 text-[10px] font-semibold bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 border border-blue-500/30 px-2.5 py-1.5 rounded-lg transition cursor-pointer shrink-0 disabled:opacity-50 w-full sm:w-auto"
                    >
                      {testingWebhook ? (
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
                  <div className="relative flex-1 min-w-0">
                    <select
                      ...
                      className="w-full min-w-0 px-3 py-2.5 bg-white/[0.03] border border-white/[0.08] rounded-xl text-neutral-200 text-xs font-medium focus:outline-none focus:border-blue-500/50 truncate cursor-pointer"
                    >
                      {jobs.map((j) => (
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2.5 rounded-xl text-xs transition cursor-pointer disabled:opacity-50 shrink-0 whitespace-nowrap shadow-sm shadow-blue-600/25 active:scale-[0.98]"
                  >
                    {isSending ? (
